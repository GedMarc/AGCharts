 ...
 */
public class AgBarChart extends AgChart<AgBarChart>
{
    ...
    public AgBarChart setData(List<?> data)
    {
        this.data = data;
        return this;
    }

    public AgBarChart setXName(String xName)
    {
        this.xName = xName;
        return this;
    }

    public AgBarChart setYName(String yName)
    {
        this.yName = yName;
        return this;
    }
